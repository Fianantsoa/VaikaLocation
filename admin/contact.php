                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="bi bi-chevron-right active" aria-current="page">Contacts</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <style>
                                ...
                                <h6 class="card-subtitle">Vous pouvez consulter tous 
                                    les clients qui veulent rester en contact ici.</h6>
                                <h6 class="card-title mt-5">
                                <?php include("php/post_contact_admin.php") ?>
