            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Les Commentaires</h4>
                    </div>
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="bi bi-chevron-right active" aria-current="page">Commentaires</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <style>
                                ...
                                <?php
                                    if($_SESSION['delete_comment'] === "success"){
                                ...
                                <h6 class="card-subtitle">Vous pouvez consulter tous 
                                    les commentaires des visiteurs ici.</h6>
                                <?php include("php/post_comment_admin.php") ?>
