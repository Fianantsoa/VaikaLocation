                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="bi bi-chevron-right active" aria-current="page">SMTP</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <style>
                                ...
                                <?php
                                    if($_SESSION['delete_contact'] === "success"){
                                        echo '<p style="position: fixed;font-size: 14px;
                                        color: green;z-index: 100;top: -19px;left: 50%;animation:message 5s linear">
                                            Suppression réussi !
                                        </p>';
                                        $_SESSION["delete_contact"] = "";
                                    }
                                ?>
                                <h4 class="card-title">Configuration SMTP</h4>
                                <h6 class="card-subtitle">Vous pouvez configurer ici le smtp qui permet d'envoyer des 
                                    emails au client et 
                                    d'avoir une alert sur l'email de votre site.</h6>
                                <h6 class="card-title mt-5">
                                <?php include("php/post_smtp_admin.php") ?>
