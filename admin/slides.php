            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Images slide</h4>
                    </div>
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="bi bi-chevron-right active" aria-current="page">Images slide</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div style="display: flex;position:relative">
                                    <div>
                                        <h4 class="card-title">Liste des images dans le slide</h4>
                                        <h6 class="card-subtitle">Vous pouvez consulter tous 
                                            les images dans le slide de l'en-tête.</h6>
                                    </div>
                                </div>


                                <?php include("php/post_img_slide.php") ?>
                            </div>
